...
Everything you cite from other sources should be properly referenced. The QMUL Faculty of Science and Engineering has identified the Vancouver referencing style and the IEEE style as the recommended styles for project reports. Details about the referencing style and examples can be found online. \href{https://www.qmul.ac.uk/library/academic-skills/referencing-hub/referencing-guides-and-resources}{https://www.qmul.ac.uk/library/academic-skills/referencing-hub/referencing-guides-and-resources}

It is recommended to prepare the references with a reference management software, such as \href{https://qmplus.qmul.ac.uk/mod/book/view.php?id=663133&chapterid=73651}{EndNote} or \href{https://qmplus.qmul.ac.uk/mod/book/view.php?id=663133&chapterid=73653}{Zotero} to automate some of the processes of collecting, managing and using references. Queen Mary Library Services promote the use of \href{http://ezproxy.library.qmul.ac.uk/login?url=https://www.citethemrightonline.com/}{Cite Them Right Online} (login required) as a tool to support Queen Mary students in their referencing.
...
Queen Mary University of London. Student Guide to Generative AI [Internet]. 2024 [cited 15 Jan 2026]. Available from: \href{https://www.qmul.ac.uk/library/academic-skills/student-guide-to-generative-ai/}{https://www.qmul.ac.uk/library/academic-skills/student-guide-to-generative-ai/}
%%%%%%%%%%% delete up to here%%%%%%%%%%%%
